...
// 	logging.ShowMessage("info", fmt.Sprintf("Building image %s:%s", app.AppName, tag), true, true)
...
// 	// build the image
// 	imageName := build()
// 	logging.ShowMessage("success", "built image "+imageName, true, true)
// 	currentDir, _ := os.Getwd()
// 	infraPath := filepath.Join(currentDir, "infrastructure")
// 	deploy(infraPath, imageName)
// 	logging.ShowMessage("success", "Infrastructure setup Done!", true, true)
// 	return nil
// }
