...
// 	logging.ShowMessage("doc", `First, create a new Project called "serverless-demo"`, true, false)
// 	logging.ShowMessage("doc", `This will also prompt you to create your first service. Let's call it "middleware" . Lets make this service in Nodejs`, true, false)
...
// 	}
// 	logging.ShowMessage("doc", `Add a lambda function to the "middleware" serverless project. Once you run this command, stew adds the function configuration, handler code and a test file`, true, false)
...
// 	logging.ShowMessage("success", `Now that we have some code in place, let's try running it offline `, true, false)
...
// 	logging.ShowMessage("success", `Your serverless app is running offline on port 4000`+appPath, true, false)
