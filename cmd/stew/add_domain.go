...
// 		// project directory
// 		var appName string
// 		logging.ShowMessage("info", "Your are running this command from your project directory. You'll have to choose a service", true, false)
...
// 		app.AppName = appName
// 	case 0:
// 		logging.ShowMessage("info", "Your are running this command from your service directory", true, false)
// 	case -1:
...
// 	showError(err)
// 	logging.ShowMessage("info", fmt.Sprintf("Detected Language %s and framework %s", app.Language, app.Framework), true, false)
...
// 	showError(err)
// 	logging.ShowMessage("success", fmt.Sprintf("Successfully created additional domain %s for service!", domain), true, true)
