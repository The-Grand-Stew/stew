...
// 	logging.ShowMessage("info", fmt.Sprintf("Detected language %s and framework %s for your app", app.Language, app.Framework), true, true)
// 	// Ask for a database
...
// 	}
// 	app.UpdateAppConfig()
// 	logging.ShowMessage("success", fmt.Sprintf("Successfully bootstrapped code in service %s for database %s!", app.AppName, app.Database), true, true)
